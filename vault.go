...
var (
	DecryptReaderVar = cipher.DecryptReader
	EncryptWriterVar = cipher.EncryptWriter
)
...
func (v *Vault) load() error {
	...
	defer f.Close()
	r, err := DecryptReaderVar(v.encodingKey, f)
	if err != nil {
		return err
	}
...
func (v *Vault) save() error {
	...
	defer f.Close()
	w, err := EncryptWriterVar(v.encodingKey, f)
	if err != nil {
		return err
	}
